...
import proflie_Img from "../../assets/profile_img.jpeg";
...
const Home = () => {
  ...
  return (
      <div className="flex justify-evenly items-center h-4/5 my-12">
        ...
        <div ref={aboutRef} className="flex flex-col justify-center gap-6 w-2/5" style={{height: "600px"}}>
          <div>
          ...
          <div>
            <NavLink 
            to="/contact"
            className="text-white text-2xl py-3 px-4 mr-3 rounded-full bg-gradient-to-r from-purple-500 to-orange-500 hover:border-blue-500 border-2 border-white  transition-all duration-50">
            Connect With Me
            </NavLink>
            <button
            className="text-white text-2xl py-3 px-4 ml-3 rounded-full bg-black hover:border-2 hover:border-blue-500 border-2 border-white  transition-all duration-50">
            My Resume
            </button>
          </div>
        </div>
